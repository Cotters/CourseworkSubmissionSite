...
/**
 * Is the user a module leader (teacher)
 * @return boolean
 */
        public function isteacher()
        {
            return is_object($this->hasrole('Site', 'Teacher'));
        }
 ...
 */
        ...
        {
            return is_object($this->hasrole('Site', 'External'));
        }
 ...
 */
        ...
        {
            return is_object($this->hasrole('Site', 'Administrator'));
        }
